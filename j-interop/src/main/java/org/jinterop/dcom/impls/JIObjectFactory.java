...
public class JIObjectFactory {
     ...
     * associated with this <code>comObject</code>. This method will raise an
     * exception if the <code>identifier</code> is invalid.
     *
     * @param comObject
     * @param identifier
     * @throws JIException
     ...
     * which can be safely casted to <code>IJIDispatch</code> interface.
     *
     * @param comObject
     * @return
     * @throws JIException
     * @throws IllegalArgumentException if <code>comObject</code> is
     * <code>null</code> or a local reference.
     */
    ...
    /**
     * Returns a <b>local</b> COM Object representation for the Java component.
     * <code>IJIComObject.IsLocalReference()</code> method will return
     * <code>true</code> for all objects built by this method. Another important
     * point to note is that a <code>javaComponent</code> can only export one
     * reference to itself. Reusing the same <code>javaComponent</code> in
     * another call to this method will raise an exception.
     *
     ...
     *
     * @param session session to attach <code>comObject</code> to. If required
     * the framework will create a new session for this <code>comObject</code>
     ...
     * @return
     * @throws JIException
     * @throws IllegalArgumentException if <code>rawBytes</code> is an invalid
     * representation.
     */
     ...
     * used. If this param is <code>null</code> then the first binding obtained
     * from the interface pointer is used.
     * @return
     * @throws JIException
     * @throws IllegalArgumentException if <code>rawBytes</code> is an invalid
     * representation.
