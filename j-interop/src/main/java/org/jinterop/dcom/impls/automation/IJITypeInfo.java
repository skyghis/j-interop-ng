 ...
 * ITypeInfo, an interface typically used for reading information about objects.
 ...
 * Type information interfaces are intended to describe the parts of the
 * application that can be called by outside clients, rather than those that
 * might be used internally to build an application.
 * <p>
 * The ITypeInfo interface provides access to the following:  <UL>
 * <li>The set of function descriptions associated with the type. For
 * interfaces, this contains the set of member functions in the interface.<li>
 * The set of data member descriptions associated with the type. For structures,
 * this contains the set of fields of the type. <li>The general attributes of
 * the type, such as whether it describes a structure, an interface, and so on.
 * </i>
 * <p>
 * Please note that all APIs of <code>ITypeInfo</code> have not been
 * implemented. <br>
 *
 * @since 1.0
 *
...
public interface IJITypeInfo extends IJIComObject {
     ...
     * specified function.
     *
     * @param index index of the function whose description is to be returned.
     * The index should be in the range of 0 to 1 less than the number of
     ...
     * description within that type library. <br>
     *
     ...
     * @return Object[0] = JIString of BSTR type, Object[1] = JIString of BSTR
     * type, Object[3] = JIString of BSTR type
     * @throws JIException
     */
     ...
     * in a DLL. <br>
     *
     * @param memberId ID of the member function whose DLL entry description is
     * to be returned.
     * @param invKind Specifies the kind of member identified by
     * <code>memberId</code>. This is important for properties, because one
     * memid can identify up to three separate functions.
     * @return Object[0] = JIString of BSTR type, Object[1] = JIString of BSTR
     * type, Object[2] = Short
     * @throws JIException
     */
     ...
     *
     * @param index index of the variable whose description is to be returned.
     * The index should be in the range of 0 to 1 less than the number of
     ...
     * interfaces, if any exist. <br>
     *
     * @param index index of the implemented type whose handle is returned. The
     * valid range is 0 to the cImplTypes field in the TypeAttr structure.
     * @return
     * @throws JIException
     */
     ...
     * base interface in a type description. <br>
     *
     * @param index index of the implemented interface or base interface for
     ...
     * the referenced type descriptions. <br>
     *
     ...
     *
     * @param memberId member ID that indicates which marshaling information is
     * needed.
     *
     * @return
     * @throws JIException
