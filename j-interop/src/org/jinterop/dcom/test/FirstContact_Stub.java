...
//            JIVariant[] rt = dispatch.callMethodA("testSafeArrayOfVariants", new Object[]{JIVariant.EMPTY_BYREF});
		   ...
		   // dispatch.callMethod("testArrayOfVariants",new Object[]{new JIArray(new JIVariant[]{new JIVariant(new JIArray(new JIString[]{new JIString("ab"),new JIString("cd")}))},true)});
			...
			//JIVariant[] c2 = dispatch.callMethodA("Request", new Object[]{new JIString("rtrtr"),new JIVariant(new JIVariant(arry34)),JIVariant.EMPTY_BYREF,JIVariant.EMPTY_BYREF} );
			...
			//JIArray arry34 = new JIArray(new JIVariant[]{new JIVariant(new JIString("40807810804000300798")),new JIVariant(new JIString("1"))},true);
			//dispatch.callMethodA("Request", new Object[]{new Integer(8194),arry34,JIVariant.EMPTY_BYREF,JIVariant.EMPTY_BYREF} );
...
//			JIArray tr = ref.getObjectAsArray();
		...
		//	Object[] t1 = dispatch.callMethodA("GetFlavorsWithPrices", new Object[]{JIVariant.EMPTY_BYREF} );
			...
			//JIVariant[] c = dispatch.callMethodA("Request", new Object[]{new Integer(8194),new JIVariant(new JIVariant(arry34)),JIVariant.EMPTY_BYREF,JIVariant.EMPTY_BYREF} );
			//JIVariant[] c = dispatch.callMethodA("Request", new Object[]{new Integer(8194),arry34,JIVariant.EMPTY_BYREF,JIVariant.EMPTY_BYREF} );
