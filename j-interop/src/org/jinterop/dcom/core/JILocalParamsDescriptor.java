 ...
 * by this class is returning multiple objects then use the return type of the
 * implementation as an <code>Object[]</code>
 *
 * <p>
 * For example:- <br>
 *
 ...
 * <br>
 * void NewWindow2( [in, out] IDispatch** ppDisp, [in, out] VARIANT_BOOL*
 * Cancel);
 * <p>
 ...
 * </code> and the Java implementation must return an <code>Object[]</code> in
 * this case, for returning the 2 parameters back.
 * <p>
...
public final class JILocalParamsDescriptor implements Serializable {
    ...
    /**
     * Add <code>[in]</code> parameter of the type <code>clazz</code> at the end
     * of the out parameter list.
     *
     * @param clazz
     * @param FLAGS
     */
