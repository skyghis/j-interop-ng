...
public class JIComFactory {
	...
	public static IJIComObject createCOMInstance(IJIComObject template, JIInterfacePointer ptr) throws JIException
	{
		...
		IJIUnknown retval = new JIComObjectImpl(template.getAssociatedSession(),template,ptr);
		...
		//template.getAssociatedSession().addToSession((ptr.getIPID()),ptr.getOID());
		template.getAssociatedSession().addToSession((IJIComObject)retval,ptr.getOID());
		return (IJIComObject)retval;
	}
