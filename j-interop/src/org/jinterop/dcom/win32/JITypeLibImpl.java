 ...
 * @since 1.0
 */
final class JITypeLibImpl extends JIDefaultComObjectImpl implements IJITypeLib {
	...
	public Object[] findName(JIString nameBuf,int hashValue,short found) throws JIException
	{
		...
		callObject.addOutParamAsObject(new JIArray(JIInterfacePointer.class,null,1,true,true),JIFlags.FLAG_NULL);
