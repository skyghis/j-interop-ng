...
/**
 * <p>
 * A collection of utility methods used throughout this project.</p>
 *
...
public class Util {
     ...
     *
     * <p>
     * This method calls the method with same name and three arguments as:</p>
     *
     * <pre>
     ...
     * returned as a large big-endian integer.</p>
     *
     * @param ba the byte array to convert.
     * @param offset the index from which to start considering the bytes to
     * convert.
    ...
    /**
     * <p>
     * Returns a byte array from a string of hexadecimal digits.</p>
     *
    ...
    /**
     * <p>
     * Returns a number from <code>0</code> to <code>15</code> corresponding to
     * the designated hexadecimal digit.</p>
     *
     ...
     *
     * <p>
     * Used by SASL password file manipulation primitives.</p>
     *
    ...
    /**
     * <p>
     * The inverse function of the above.</p>
     *
     * <p>
