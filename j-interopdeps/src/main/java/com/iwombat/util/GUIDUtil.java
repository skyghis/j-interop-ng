 ...
 *
 * <p>
 * Due to how MS structures a UUID (GUID) in c and its decomposition into a
 * string, there are some rather unique little endian conversions that take
 * place. <br>
 * For example:<br>
 ...
 * </pre>
 *
 * Note: These conversions will leave the original version and variant in tact
 * and will not convert to the MS version and variant or vice-versa.
 *
