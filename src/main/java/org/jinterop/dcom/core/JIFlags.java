...
public final class JIFlags {
    ...
    /**
     * Flag representing <code>VARIANT_BOOL</code>, a <code>boolean</code> is 2
     * bytes for a <code>VARIANT</code> and 1 byte for normal calls. Use this
     * when setting array of <code>boolean</code>s within <code>VARIANT</code>s.
     */
    public static final int FLAG_REPRESENTATION_VARIANT_BOOL = 8192;

    /**
     * Represents an internal flag, which will disallow direct Strings from
     * being marshalled or unmarshalled. Come via JIString only.
     */
    ...
    /**
     * Used in JIVariant when sending a IUnknown Pointer. This is also how COM
     * runtime does it. A little strange to expect this behaviour since
     * essentially all objects derieve from IUnknown so why replace the IID ?
     */
    static final int FLAG_REPRESENTATION_USE_IUNKNOWN_IID = 65536;

    /**
     * Used in JIVariant when sending a IDispatch Pointer. This is also how COM
     * runtime does it.
     */
